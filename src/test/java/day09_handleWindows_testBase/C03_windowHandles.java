    ...
    public void test01(){
        ...
        Assert.assertEquals(expectedTitle,actualTitle);
            ...
            /*
                ...
                o zamnan sayfalarin window handle degerlerini elde etmem gerekir
        ...
        driver.findElement(By.linkText("Click Here")).click();
            ...
            /*
                yeni sayfaya geç-cme icin oncelikle ikinciSayfaWindowHandleDegeri'ni bulmamiz gerekir
                bunun icin driver.getWindowHandles() method'unu kullanarak
                acik olan tum sayfalarin window handle degerleini alip bir Set'e assign ederiz

                ilk sayfanin window handle degerini zaten biliyoruz
                Set'deki widow handle degerlerini kontrol edip
                ilk sayfabin handle degerine esit olmayan
