...
public class C04_DropDownMenu {
    ...
    public void test02() throws InterruptedException {
        ...
        select.selectByVisibleText("Books"); // gorunur isimle seciyor
       /* select.selectByIndex();  // index'le seciyor
        select.selectByValue();  // value ile seciyor

        not: 3'unu birden kullanmayiz
        */
        ...
        String sonucYazisiStr=sonucYazisiElementi.getText();    // bunu yapmazsak hata olur
        String arananKelime="Java";
        Assert.assertTrue(sonucYazisiStr.contains(arananKelime));   // burada test yapiyoruz
        Thread.sleep(5000);
